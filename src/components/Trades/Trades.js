  ...
  <div>
        ...
        <div class="flex items-center justify-between">
            ...
            <nav>
                <ul class="flex space-x-6">
                    ...
                    <li><a href="#" class="hover:text-gray-200">Trade</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <div class="flex">
        ...
        <main class="w-2/3 bg-white p-4">
            ...
            <div class="mb-6">
                <input type="text" placeholder="Search..." class="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"></input>
            </div>
            ...
            <table class="min-w-full table-auto border-collapse">
                ...
                <tbody>
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2"><button class="bg-blue-500 text-white px-4 py-2 rounded">Buy</button></td>
                    </tr>
                    <tr class="border-b">
