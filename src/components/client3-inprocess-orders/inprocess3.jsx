            ...
            <header className='bg-gray-700 text-white p-4'>
                <div className='flex items-center justify-between'>
                    <div className='text-xl font-bold'>
                        <img src='https://exitmap.com/wp-content/uploads/2022/03/Edward-Jones-logo.png' alt='Logo' class='h-8 inline-block mr-3' /> Online Access - Client Brad in process Orders
                    </div>
                    <nav>
                    ...
                    <table className='min-w-full table-auto border-collapse '>
                        ...
                        <tbody>
                            <tr className='border-b'>
                                ...
                                <td className='px-4 py-2 text-center'>Buy Order Pending</td>
                            </tr>
