      ...
      <div className='mx-auto'>
        <div className='max-w-screen-md mx-auto'>
          ...
          <form className='flex flex-col mx-auto max-w-[70%]'>
            ...
            <button className='bg-[#0076a0] rounded mt-8 py-4 text-white' onClick={handleLoginClient1}>Client 2 - John</button>
            <button className='bg-[#0076a0] rounded mt-8 py-4 text-white' onClick={handleLoginClient1}>Client 3 - Brad</button>
